export const worldCountries = [
  ...
  { code: "JP", name: "Jepang", flag: "🇯🇵", currency: "JPY" },
  ...
  { code: "KR", name: "Korea Selatan", flag: "🇰🇷", currency: "KRW" },
  ...
  { code: "KN", name: "Saint Kitts and Nevis", flag: "🇰🇳", currency: "XCD" },
  { code: "LC", name: "Saint Lucia", flag: "🇱🇨", currency: "XCD" },
  { code: "VC", name: "Saint Vincent and the Grenadines", flag: "🇻🇨", currency: "XCD" },
  { code: "WS", name: "Samoa", flag: "🇼🇸", currency: "WST" },
  { code: "SM", name: "San Marino", flag: "🇸🇲", currency: "EUR" },
  { code: "ST", name: "Sao Tome and Principe", flag: "🇸🇹", currency: "STN" },
  ...
  { code: "SG", name: "Singapura", flag: "🇸🇬", currency: "SGD" },
  ...
  { code: "TT", name: "Trinidad and Tobago", flag: "🇹🇹", currency: "TTD" },
  ...
  { code: "AE", name: "Uni Emirat Arab", flag: "🇦🇪", currency: "AED" },
  { code: "GB", name: "Inggris Raya", flag: "🇬🇧", currency: "GBP" },
  { code: "US", name: "Amerika Serikat", flag: "🇺🇸", currency: "USD" },
